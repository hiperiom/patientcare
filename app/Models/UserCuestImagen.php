...
class UserCuestImagen extends Model
{
    ...
    static function store (Request $request)
    {
        ...
        if (!is_null($file)) {
            ...
            return Response()->json(UserCuestImagen::show($request->user_id));
    }
    static function store_index (Request $request)
    {
    ...
    {
        return UserCuestImagen::where("user_id",$user_id)->get();
    }
    ...
    {
        $model = UserCuestImagen::find($request->id);
            $model->coments = $request->coments;
            $model->user_id_medico =Auth::id();
    ...
    {
        $model = UserCuestImagen::where('id',$id);
        ...
        $model->delete();
        return Response()->json(UserCuestImagen::show($id));
    }
}
