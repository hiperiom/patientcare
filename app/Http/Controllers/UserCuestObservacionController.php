...
class UserCuestObservacionController extends Controller
{
    public function store(Request $request)
    {
        return UserCuestObservacion::store($request);
    }
    public function destroy($id)
    {
        return UserCuestObservacion::eliminar($id);
    }
    public function temporal()
    {
        ...
        foreach ($model as $key => $value) {
            DB::table('user_cuest_observacion')
