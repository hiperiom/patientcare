...
class UserCuestOtroArchivoController extends Controller
{
    /**
    ...
    {
        return UserCuestOtroArchivo::store($request);
    }
    public function store_cita(Request $request)
    {
        return UserCuestOtroArchivo::store_cita($request);
    }
    public function index_by_cita($cita_id)
    {
        return UserCuestOtroArchivo::index_by_cita($cita_id);
    }
     ...
     *
     * @param  \App\OtroArchivo  $otroArchivo
     * @return \Illuminate\Http\Response
     */
    public function show(Request $otroArchivo)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $otroArchivo)
    {
        //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return UserCuestOtroArchivo::actualizar($request);
    }
    ...
    {
        return UserCuestOtroArchivo::eliminar($id);
    }
    public function subirImagen(Request $request)
    {
       ...
       // dd($request->all());
        ...
        $nombre = "otro_".$aleatotio. $request->user_id_paciente . '-' . str_replace(' ', '', $file->getClientOriginalName());
        if (file_exists('image/user/archivo_informe/'.$nombre)) {
            return "imagen existe";
        }
		$file->move('image/user/archivo_informe/', $nombre);

        $public_path = public_path();
        $info = new SplFileInfo($file->getClientOriginalName());

        $model = UserCuestOtroArchivo::create([
    ...
    public function temporal()
    {
        ...
        foreach ($model as $key => $value) {
            DB::table('user_cuest_otro_archivo')
