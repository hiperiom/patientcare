    ...
    <div class="flex-fill px-2 d-flex flex-column overflow-auto">
        <div class="d-flex flex-wrap mb-2">
            <div class="col-12 col-sm-6 pl-0">
                <h4 class="text-success px-1">Confirmadas</h4>
            </div>
                ...
                <tbody>
                    ...
                    <tr class="text-secondary">
                        ...
                        <td class="p-1 botones-fila"  style="width: 160px;">
                            ...
                            <a class="btn btn-success btn-block btn-sm asistio-cita" data-btn-id="8" data-cat_user_cita_status_id="4" href="#" role="button" data-cita_id="27248" data-user_id_paciente="358171">
                                <img class="asistio-cita" src="/image/system/calendar-check.svg" style="width:15px;height:15px;" alt="Not Image Found" data-cita_id="27248" data-user_id_paciente="358171"> ¿Asistió?
                            </a>
