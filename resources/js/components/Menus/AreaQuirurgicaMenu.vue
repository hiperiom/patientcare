<template>
        ...
        <aside ref="sidebar-left" :class="{'bg-white shadow-sm rounded-1 mb-1 sidebar-left shadow-box col col-sm-3 col-md-2 d-none flex-column ':true, 'd-flex show':showMenuLeft}">
            ...
            <nav class="nav flex-column nav-pills m-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <router-link :class="{'nav-link':true, 'active':this.$route.path=='/areaQuirofano/index_quirofano'}" data-toggle="pill" to="/areaQuirofano/index_quirofano">Plan Programado</router-link>
                <!-- <router-link :class="{'nav-link':true, 'active':this.$route.path=='/areaQuirofano/index_finalizadas'}" data-toggle="pill" to="/areaQuirofano/index_finalizadas">Plan Ejecutado</router-link> -->
<!--                 <router-link :class="{'nav-link':true, 'active':this.$route.path=='/areaQuirofano/enfermeria/index_enfermeria'}" data-toggle="pill" to="/areaQuirofano/enfermeria/index_enfermeria">Enfermería</router-link>
