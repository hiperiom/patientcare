                ...
                <div class="row flex-nowrap">
                            ...
                            <div class="d-flex align-items-center">
                                <div data-tippy-content="Cédula del paciente" class="tooltip-primary flex-fill pl-1">
                                    ...
                                    <div class="text-secondary">
                                        {{ patient_data.nacionalidad+patient_data.cedula }}
                                    </div>
                                </div>
                                <div data-tippy-content="Edad" class="tooltip-primary flex-fill pl-1 border-left border-right">
                                    ...
                                    <div class="text-secondary">{{ patient_data.edad }}</div>
                                </div>
                                <div data-tippy-content="Sexo" class="tooltip-primary flex-fill pl-1">
                                    <b class="text-primary" style="font-size: 0.8rem;">Sexo</b>
                                    <div class="text-secondary">{{ patient_data.genero.toUpperCase() }}</div>
                                </div>
                            </div>
                            <small class="text-light" style="font-size: 0.7em;">#{{ patient_data.user_id }}</small>
                        </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-lg-2 col-xl-1  px-0 d-flex flex-column">
                        <div class="flex-fill mb-1 p-1 card">
                            ...
                            <div class="text-secondary">
                                <input
                                    :id="'ingreso'+patient_data.user_id"
                                    type="date"
                        ...
                        <div data-tippy-content="Ubicación Actual | Días desde el ingreso" class="tooltip-primary flex-fill mb-1 p-1 card">
                            ...
                            <div class="text-secondary text-center">
                                ...
                                <span class="badge badge-secondary">{{ patient_data.dias }}</span>
                        ...
                        <div class="flex-fill mb-1 p-1 card">
                            ...
                            <div class="text-secondary">
                                <a
                                    target="_blank"
                                    :href="'https://api.whatsapp.com/send?phone='+ (!['null',null].includes(patient_data.telefono_movil) ? patient_data.telefono_movil.replace('+', '') : '')"
                                    class="btn btn-default btn-block"
                                    style="padding: 0% 3% 3%; border: 0px; line-height: 1.4;">
                                    <div class="text-gray text-nowrap overflow-hidden">
                                        <i class="fab fa-whatsapp text-success"></i> {{ !['null',null].includes(patient_data.telefono_movil) ? patient_data.telefono_movil.replace('+', '') : '' }}
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div id="equipoEspecialistas" role="tabpanel" aria-labelledby="equipoEspecialistas-tab" class="tab-pane fade show active">
                                    <div id="doctoresPaciente" scope="row" class="p-0 pb-1">
                                        <!-- <ListEquipoMedico
                                            :medic_teem_patient="patient_data.medico_paciente"
                                            :episodio_id="patient_data.episodio_id"
        ...
        <ul class="list-group flex-grow-1 flex-nowrap flex-row overflow-auto mini-cintillo">
            ...
            <li class="list-group-item p-1 mr-1 text-nowrap">
                <div class="d-flex flex-column">
                    ...
                    <div class="overflow-hidden" >
                        <input
                            :id="'ingreso2'+patient_data.user_id"
                            type="date"
                            :value="getFechaIngreso()"
                            class="cursor-pointer"
                            style="
...
<script>
import { fechaAMD,fechaCustom1 } from '../../../../../helpers/customHelpers.js';
//import ListEquipoMedico from './ListEquipoMedico.vue';
    export default {
        ...
        methods: {
            ...
            getFechaIngreso() {
                return fechaAMD(this.patient_data.ingreso_episodio)
            },
            getProbDiagnostica(){
                return this.patient_data.resultados.filter(item=>{
