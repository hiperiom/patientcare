<template>
    <div class="dropdown">
        <button :id="propName + '_' + patient_data.user_id" class="btn btn-default p-1" type="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i
                :class="[getIcon, ('text-' + getColor), { 'ping-2': Number(riesgo_value) === 1 }, { 'ping': Number(riesgo_value) === 2 }]"></i>
        </button>
