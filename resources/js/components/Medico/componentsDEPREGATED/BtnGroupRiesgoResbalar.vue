    ...
    export default {
        ...
        data(){
            return {
                ...
                route_update:"user_cuest_resbalar",
                currentValue:3,
                fieldName:"resbalar_riesgo",
                episodio_prop_name:"resbalar_riesgo_value",
                episodio_prop_name2:"resbalar_riesgo_description",
                icon:"pc-resbalar",
                dropdownOptions:[
