            ...
            <div id="level_1" class="row justify-content-center align-items-start">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="d-flex">
                                        <button data-toggle="collapse" data-target="#collapseAREAQX"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-hospital h3 mb-0 mr-2"></i>
                                                <div class="f-size-total">{{ datos.area_qx.ejecutadas.total }}</div>
                                                <div class="flex-fill ml-1 d-flex flex-column">
                                                    <div class="d-flex align-items-center">
                                                        <i class="fas fa-user w-icon-user-type"></i>
                                                        <div>{{ datos.area_qx.ejecutadas.adulto }}</div>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <i class="fas fa-child w-icon-user-type"></i>
                                                        <div>{{ datos.area_qx.ejecutadas.pediatrico }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </button>
                                    ...
                                    <div id="collapseAREAQX" class="collapse mt-1">
                                        <div class="d-flex">
                                            <button
                                                ...
                                                <h1 class="mb-0">{{ datos.area_qx.hospitalizacion.ejecutadas.total }}</h1>
                                                <div class="mx-2 d-flex flex-column justify-content-center"
                                                        style="line-height: 1rem;">
                                                    <div class="mb-1 d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                        ...
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.ejecutadas.adulto }}</div>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                            <i class="fas fa-child"></i>
                                                        </div>
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.ejecutadas.pediatrico }}</div>
                                                    </div>
                                                </div>
                                            </button>
                                            <button @click="getNewDataPacienteQx('qx_hospitalizacion')" type="button" class="glassmod-effect group mb-1 border-0 rounded-custom-right"><i class="pc-paciente h5 mb-0"></i></button>
                                        </div>
                                        <div id="collapseEHOSPITALIZACION" class="collapse  rounded-custom">
                                            <button
                                                @click="getNewDataPacienteQx('qx_hospitalizacion_electiva')"
                                                class="glassmod-effect group w-100 border-0 mb-1 d-flex px-3 align-items-center rounded-custom">
                                                <b class="ml-4 mr-2 flex-fill text-left text-uppercase">
                                                    AMBULATORIA TORRE
                                                </b>
                                                <h1 class="mb-0">{{ datos.area_qx.hospitalizacion.ambulatoria_torre.ejecutadas.total }}</h1>
                                                <div class="mx-2 d-flex flex-column justify-content-center"
                                                    style="line-height: 1rem;">
                                                    <div class="mb-1 d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                        ...
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.ambulatoria_torre.ejecutadas.adulto }}</div>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                            <i class="fas fa-child"></i>
                                                        </div>
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.ambulatoria_torre.ejecutadas.pediatrico }}</div>
                                                    </div>
                                                </div>
                                            </button>
                                            <button
                                                @click="getNewDataPacienteQx('qx_hospitalizacion_emergencia')"
                                                class="glassmod-effect group w-100 border-0 d-flex px-3 mb-1 align-items-center rounded-custom">
                                                <b class="ml-4 mr-2 flex-fill text-left text-uppercase">
                                                    HOSPITALIZACIÓN
                                                </b>
                                                <h1 class="mb-0">{{ datos.area_qx.hospitalizacion.hospitalizacion_torre.ejecutadas.total }}</h1>
                                                <div class="mx-2 d-flex flex-column justify-content-center"
                                                    style="line-height: 1rem;">
                                                    <div class="mb-1 d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                        ...
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.hospitalizacion_torre.ejecutadas.adulto }}</div>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <div class="mr-1" style="width: 15px;">
                                                            <i class="fas fa-child"></i>
                                                        </div>
                                                        <div class="rounded px-1">{{ datos.area_qx.hospitalizacion.hospitalizacion_torre.ejecutadas.pediatrico }}</div>
                                                    </div>
                                                </div>
                                            </button>
                                        </div>
                                        <div class="d-flex">
                                                <button
                                                    data-toggle="collapse"
                                                    data-target="#collapseEMAPM"
                                                    aria-expanded="false"
                                                    aria-controls="collapseEMAPM"
                                                    class="glassmod-effect group w-100 border-0 d-flex px-3 mb-1 align-items-center rounded-custom-left">
                                                    <b class="mr-2 flex-fill text-left text-uppercase">
                                                        TORRE MAPM
                                                    </b>
                                                    <h1 class="mb-0">{{ datos.area_qx.mapm.ejecutadas.total }}</h1>
                                                    <div class="mx-2 d-flex flex-column justify-content-center"
                                                        style="line-height: 1rem;">
                                                        <div class="mb-1 d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                            ...
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.ejecutadas.adulto }}</div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                                <i class="fas fa-child"></i>
                                                            </div>
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.ejecutadas.pediatrico }}</div>
                                                        </div>
                                                    </div>
                                                </button>
                                                <button @click="getNewDataPacienteQx('qx_ambulatoria_mapm')" type="button" class="glassmod-effect group mb-1 border-0 rounded-custom-right"><i class="pc-paciente h5 mb-0"></i></button>
                                            </div>
                                            <div id="collapseEMAPM" class="collapse  rounded-custom">
                                                <button
                                                    ...
                                                    <h1 class="mb-0">{{ datos.area_qx.mapm.oftalmologicas.ejecutadas.total }}</h1>
                                                    <div class="mx-2 d-flex flex-column justify-content-center"
                                                        style="line-height: 1rem;">
                                                        <div class="mb-1 d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                            ...
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.oftalmologicas.ejecutadas.adulto }}</div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                                <i class="fas fa-child"></i>
                                                            </div>
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.oftalmologicas.ejecutadas.pediatrico }}</div>
                                                        </div>
                                                    </div>
                                                </button>
                                                <button
                                                    ...
                                                    <h1 class="mb-0">{{ datos.area_qx.mapm.especialidades.ejecutadas.total }}</h1>
                                                    <div class="mx-2 d-flex flex-column justify-content-center"
                                                        style="line-height: 1rem;">
                                                        <div class="mb-1 d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                            ...
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.especialidades.ejecutadas.adulto }}</div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="mr-1" style="width: 15px;">
                                                                <i class="fas fa-child"></i>
                                                            </div>
                                                            <div class="rounded px-1">{{ datos.area_qx.mapm.especialidades.ejecutadas.pediatrico }}</div>
                                                        </div>
                                                    </div>
                                                </button>
                                            </div>
                ...
                <div class="col-12 col-sm col-md flex-column ">
                   ...
                   <!--  <div class="d-flex justify-content-start">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <button  @click="handleLevel1()"  data-toggle="collapse" data-target="#collapseTELEMEDICINA" aria-expanded="false"
                                aria-controls="collapseTELEMEDICINA"
                                class="mt-1 d-flex shadow-sm flex-column align-items-center justify-content-center glassmod-effect group w-100 border-0 group rounded-custom">
                                <b class="text-uppercase">TELESALUD</b>
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-hospital h3 mb-0 mr-2"></i>
                                    <div class="f-size-total">{{ datos.telesalud.total }}</div>
                                    <div class="flex-fill ml-1 d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-user w-icon-user-type"></i>
                                            <div>{{datos.telesalud.adulto}}</div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-child w-icon-user-type"></i>
                                            <div>{{datos.telesalud.pediatrico}}</div>
                                        </div>
                                    </div>
                                </div>
                            </button>
                    ...
                    <div ref="collapseTELEMEDICINA" id="collapseTELEMEDICINA" class="collapse col">
                        <div class="container-fluid p-0">
                            <div class="row justify-content-center align-items-start">
                                <div class="col">
    ...
    export default {
        ...
        data() {
            return {
                ...
                titlesModal:{
                    ...
                    'utin': "UTI NEONATAL",
                    'qx_hospitalizacion': "AQ Hospitalización",
                    'qx_hospitalizacion_electiva': "HOSP ELECTIVA",
                    'qx_hospitalizacion_emergencia': "HOSP EMERGENCIA",
                    'qx_ambulatoria': "AQ AMBULATORIA",
                    'qx_ambulatoria_torre': "AMB TORRE",
                    'qx_ambulatoria_mapm': "AMB MAPM",
        ...
        methods: {
            ...
            async getDataPacientesQx(area) {
                ...
                try {
                    this.searchigResults= true
                    const response = await fetch(`/user/admin/dataegresosqxdatospacientes/${area}/${this.desde}/${this.hasta}`);
                    const responseData = await response.json();
                    this.searchigResults= false
                    return responseData;
                } catch (error) {
