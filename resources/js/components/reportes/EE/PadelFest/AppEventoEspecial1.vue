		...
		<div class="flex-fill d-flex justify-content-center align-items-md-center">
			<div class="container p-sm-0">
				...
				<div class="row align-items-center">
					...
					<div class="col-12 col-sm-12 col-md-8 p-0 pl-sm-2">
					  <div class="container-fluid">
						<div class="row">
						  <div class="col-6 col-md-12 pr-1 pl-0">
							<div class="text-white text-center text-shadow">
								<div class="d-none d-block d-sm-block d-md-block h5">
								...
								<div class="glassmod-effect rounded-pill-1 p-1">
								  ...
								  <div class="d-flex  justify-content-center align-items-center mx-2">
									<div class="d-flex flex-column align-items-center pr-3 pr-sm-0">
										<div class="mr-1">Hoy</div>
										<div data-tippy-content="Total de Pacientes Atendidos hoy en el evento especial." class="tooltip-primary font-weight px-1 display-4">{{atencionPaciente['hoy']}}</div>
									</div>
									<div class="d-flex flex-column align-items-center pl-3 pr-sm-0">
										<div class="mr-1">Promedio Pac/dia</div>
										<div data-tippy-content="Promedio de Pacientes Atendidos por dia en el evento especial." class="tooltip-primary font-weight px-1 display-4">{{ atencionPaciente['promedio']() }}</div>
									</div>
								  </div>
								</div>
							</div>
						  </div>
						  <div class="col-6 col-md-12 pl-1 pr-0">
							<div class="text-white text-center text-shadow">
							  <div class="d-none d-block d-sm-block d-md-block h5">
								Stand
							  </div>
							  <div class="glassmod-effect rounded-pill-1 p-1">
								...
								<div class="d-flex  justify-content-center align-items-center mx-2">
								  <div class="d-flex flex-column align-items-center pr-3 pr-sm-0">
									  <div class="mr-1">Hoy</div>
									  <div data-tippy-content="Total de Pacientes Atendidos hoy en el evento especial." class="tooltip-primary font-weight px-1 display-4">{{stand['hoy']}}</div>
								  </div>
								  <div class="d-flex flex-column align-items-center pl-3 pr-sm-0">
									  <div class="mr-1">Promedio Pac/dia</div>
									  <div data-tippy-content="Promedio de Pacientes Atendidos por dia en el evento especial." class="tooltip-primary font-weight px-1 display-4">{{ stand['promedio']() }}</div>
								  </div>
								</div>
							  </div>
							</div>
...
<script scoped>
	...
	export default {
		...
		computed: {
			...
			pacientes(){
				return {
					total: this.$store.state.pacientes.filter(x=> [this.$store.state.ubicacion_id_stand,this.$store.state.ubicacion_id_ap].includes(x['cat_user_ubicacion_id'])).length,
