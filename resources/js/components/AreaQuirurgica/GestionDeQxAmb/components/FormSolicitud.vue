        ...
        <div class="flex-fill  container-fluid d-flex flex-column overflow-auto">
          <div class="d-flex py-2 flex-column flex-sm-row align-items-center  align-items-sm-center justify-content-center justify-content-sm-between">
              ...
              <div class="d-flex">
                ...
                to="/areaQuirofanoAmb/index_quirofano">Regresar</router-link>
              </div>
            </div>
            <div class="flex-fill d-flex flex-column overflow-auto">
                <div class="overflow-auto mb-4 pb-4">
                        ...
                        <div class="row">
                            ...
                            <div :class="['col-12 col-sm-6',{'d-none':edit_solicitudaaaaa}]">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="convenio">Convenio:</label>
                                    <select ref="convenio" @input="updateFormField" v-model="$store.state.formReservacionQuirofano.convenio" class="form-control bg-gray-footer-parodi mr-1" name="convenio"  id="convenio">
                                        <option value="">Seleccione</option>
                                        <option value="Particular">Particular</option>
                                        <option value="VUMI">VUMI</option>
                                        <option value="Best Doctor">Best Doctor</option>
                                        <option value="Mercantil">Mercantil</option>
                                        <option value="Mapfre">Mapfre</option>
                                        <option value="Oceanica De Seguros">Oceanica De Seguros</option>
                                        ...
                                        <option value="Multinacional De Seguros">Multinacional De Seguros</option>
                                        <option value="Piramide">Piramide</option>
                                        <option value="Par Salud">Par Salud</option>
                                        <option value="Universitas">Universitas</option>
                                        <option value="Samhoi">Samhoi</option>
                                        <option value="Bupa">Bupa</option>
                                        <option value="Seguros Venezuela">Seguros Venezuela</option>
                                        <option value="Redbrid">Redbrid</option>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select  ref="anestesia_sugerida" @input="updateFormField" v-model="$store.state.formReservacionQuirofano.anestesia_sugerida" class="form-control bg-gray-footer-parodi mr-1" name="anestesia_sugerida" id="anestesia_sugerida">
                                        ...
                                        <option value="Local con anestesiólogo">Local con anestesiólogo (Loccan)</option>
                                        <option value="Local sin anestesiólogo">Local sin anestesiólogo (Locsan)</option>
                            ...
                            <div class="container p-1 mb-3">
                                <div id="contenedor_intervencion">
                                    ...
                                    <div  :ref="'item_'+index" v-for="(item,index) in $store.state.formReservacionQuirofano.intervencion" :key="index" class="container p-0 mb-2 align-items-center d-flex">

                                        <div class="row bg-light shadow-sm mt-2 rounded-custom-1">
                                            <div class="col-12">
                                                <label class="label-text text-secondary" for="intervencion"><b v-if="$store.state.formReservacionQuirofano.intervencion.length > 1" class="text-primary h3">{{index+1}}</b> Intervención, procedimiento o estudio a realizar:</label>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div  v-if="item.description.resultset.length > 0" class="table-responsive mt-1 table-hover" style="max-height:200px;">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr @click="addIntervencionItem(index,item2)" class="text-secondary proced-found" v-for="(item2, index2) in item.description.resultset" :key="index2">
                            ...
                            <div class="col-12">
                                ...
                                <div>
                                    ...
                                    >
                                        <option  value="">Seleccione</option>
                                        <option class="text-success" value="424">MAPM Oftalmológica</option>
                                        <option class="text-success" value="425">MAPM Especialidades</option>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div :class="{'d-none': !is_hospitalizacion}">
                                    ...
                                    >
                                    <option value="">Seleccione</option>
                                    <option v-for="(item,index) in $store.state['catUbicacion'].filter(item=> ![391,390,246,223,41,2,28,182,211,391].includes(item['id']) && item['parent_cat_user_ubicacion_id']===1)" :key="index" :value="item.id">{{item.description}}</option>
                                    </select>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            async editForm(){
                ...
                if(this.$route.path !=="/areaQuirofanoAmb/edit_quirofano"){
                    localStorage.removeItem("editSolicitud")
                }
                if(this.edit_solicitudaaaaa){

                    this.listadoSolicitudesEstaCargando = true
                    let solicitud = await get("/areaQuirofanoAmb/cupo/edit/"+edit_solicitud_id)
                ...
                if (this.validate()) {
                    ...
                    let user_id = this.$store.state.formReservacionQuirofano['user_id']
                        ...
                        let result= ""
                            ...
                            if(this.$route.path=="/areaQuirofanoAmb/edit_quirofano"){
                                result = await post(location.origin + "/areaQuirofanoAmb/updateForm", formdata)
                            }else{
                                result = await post(location.origin + "/areaQuirofanoAmb/store", formdata)
                            }
                            this.$store.commit('updateProperty', {
                                fieldName:'loading',
                                fieldValue:false,
                        ...
                        Swal.fire({
                            ...
                            didClose: () => {
                                ...
                                localStorage.removeItem("editSolicitud")
                                setTimeout(() => this.$router.push('/areaQuirofanoAmb/index_quirofano') /*location.href = location.origin + "/areaQuirofano/index_quirofano"*/ , 110);
                            }
                        })
                    //console.log(result)
                }
...
.proced-found:hover{
    ...
    transition: all 0.5s; /* Duración de la animación */
    cursor:pointer;
}
</style>
