<template>
    <div class="d-flex flex-column vh-100 overflow-auto">
        ...
        <div
            class="flex-shrink-1 overflow-auto container-fluid  py-2 text-white d-flex align-items-center justify-content-between">
            ...
            <a href="#"
                class=" text-white border-0 col py-1 px-2 m-1  d-flex shadow-1 align-items-center rounded-custom-1">
                <i class="pc-light-hospital h1 mb-0 mr-1"></i>
                <h3 class="mb-0">TORRE<br>HOSPITALIZACIÓN</h3>
            </a>
            <a href="#" @click="handle_fecha_reporte"
                class="glassmod-effect glassmod-effect-btn text-white border-0 col py-1 px-2 m-1  d-flex shadow-1 flex-column align-items-center rounded-custom-1">
            ...
            <a class="glassmod-effect col py-1 px-2 m-1 rounded-custom-1" href="#">
                    ...
                    <b id="total_cirugias" class="text-white shadow-1 mr-3" style="font-size: 3rem;">
                        ...
                        <div class="ml-2 d-flex justify-content-center">
                            <div class="d-flex px-2 flex-column align-items-center">
                                ...
                                <div style="line-height: 1;">{{ totalEjeProgramadas }}</div>
                            </div>
                ...
                <div class="d-flex justify-content-between align-items-center text-white">
                    ...
                    <b id="total_hospitalizacion" class="text-white shadow-1 mr-3" style="font-size: 3rem;">
                        <div class="ml-2 d-flex justify-content-center">
                            <div class="d-flex px-2 flex-column align-items-center">
                                <small style="font-size: 14px;" title="Ejecutadas">EJEC</small>
                                <div style="line-height: 1;">{{ totalEjeHospitalizacion }}</div>
                            </div>
                            <div class="mx-1 text-center"><b class=" border-left border-white"></b></div>
                            <div class="d-flex px-2 flex-column align-items-center">
                                <small style="font-size: 14px;" title="Programadas">PROG</small>
                ...
                <div class="d-flex justify-content-between align-items-center text-white">
                    ...
                    <b id="total_ambulatoria" class="text-white shadow-1 mr-3" style="font-size: 3rem;">
                        <div class="ml-2 d-flex justify-content-center">
                            <div class="d-flex px-2 flex-column align-items-center">
                                <small style="font-size: 14px;" title="Ejecutadas">EJEC</small>
                                <div style="line-height: 1;">{{ totalEjeAmbTorre }}</div>
                            </div>
                            <div class="mx-1 text-center"><b class=" border-left border-white"></b></div>
                            <div class="d-flex px-2 flex-column align-items-center">
                                <small style="font-size: 14px;" title="Programadas">PROG</small>
        ...
        methods: {
            ...
            async getOtroPersonalAsistencial() {
                try {
                    ...
                    let model = await get(location.origin + "/areaQuirofano/personal_asistencial/gelAllOtroPersonal")
                    this.$store.commit('updateProperty', {
            ...
            async getSolicitudes() {
                try {
                    ...
                    let model = await get(location.origin + "/areaQuirofano/cupo/getAllExterno/" + this.$store.state.fecha_reporte + "?area_intervencion=hospitalizacion")
        ...
        computed: {
            totalEjeProgramadas() {
                return this.$store.state.solicitudes.filter(x => {
                    return x.h_fin !== null
                    /* !['Suspendida'].includes(x.fase_ubicacion) && */
                    /*  &&
                        [418].includes(Number(x['area_intervencion'])) */


                }).length
            },
            totalEjeHospitalizacion() {
                return this.$store.state.solicitudes.filter(x =>
                    !['Suspendida'].includes(x.fase_ubicacion) &&
                    x.h_fin !== null &&
                    [418].includes(Number(x['area_intervencion']))
            ...
            totalEjeAmbTorre() {
                return this.$store.state.solicitudes.filter(x =>
                    !['Suspendida'].includes(x.fase_ubicacion) &&
                    x.h_fin !== null &&
                    [422].includes(Number(x['area_intervencion']))
                ).length
            },
            mostrarLoading() {
