...
import ColumnaPersonalEnfermeria from './ColumnaPersonalEnfermeria.vue';
    ...
    import TodolistDropdownPreanestesia from './TodolistDropdownPreanestesia.vue';
    import TodolistDropdownRecuperacion from './TodolistDropdownRecuperacion.vue';
    import TodolistDropdownObstetrico from './TodolistDropdownObstetrico.vue';
    export default {
        components:{
            TodolistDropdown,
            ColumnaPersonalEnfermeria,
