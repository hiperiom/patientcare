            ...
            <div
                ...
                <div class="dropdown">
                    ...
                    >
                        <div class="d-flex  text-primary ">
                            <i class="h3 mb-0 pc-light-hospital"></i>
                            <div class="ml-1 d-flex flex-column align-items-start">
                                <h3 class="mb-0">TORRE HOSPITALIZACIÓN</h3>
                                <div class="title-option-pagemb-0">{{ $route.name }}</div>
                            </div>
                        </div>
                    </button>
                    <div class="dropdown-menu" aria-labelledby="triggerId">
                        <a class="dropdown-item  active" href="/areaQuirofano/index_quirofano">Área Hospitalización</a>
                        <a class="dropdown-item" href="/areaQuirofanoAmb/index_quirofano">Área MAPM</a>
                    </div>
                </div>
                <div>
                ...
                <div class="d-flex">
                    ...
                    <router-link target="_blank" class="btn btn-success mt-1 mr-1 mt-sm-0"
                        to="/areaQuirofano/externo/iqx">Plan Quirúrgico</router-link>
                    <router-link class="btn btn-primary-custom mt-1  mr-1 mt-sm-0"
                        to="/areaQuirofano/create_quirofano">Nueva Programación</router-link>
...
import { fechaDMA, get, fechaAMD, meses, post, is_undefined, store_field, mesesEnEspanol } from '../../../../../helpers/customHelpers.js';
