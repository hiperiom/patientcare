    ...
    <div class="flex-grow-1 d-flex flex-column overflow-auto" id="content">
        <div class="flex-fill  container-fluid d-flex flex-column overflow-auto">
            <div
                ...
                <div class="title-option-page text-primary mb-0">
                    {{ $route.name }}<br>
                    Torre Hospitalización
                </div>
                <div class="d-flex">
                    <router-link target="_blank" class="btn btn-success mt-1 mr-1 mt-sm-0"
                        to="/areaQuirofano/externo/index">Plan Quirúrgico</router-link>
            ...
            <div class="flex-fill d-flex flex-column overflow-auto">
                <div class="overflow-auto mb-4 pb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select ref="tipo_cupo" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.tipo_cupo" type="text"
                                        class="form-control bg-gray-footer-parodi mr-1" name="tipo_cupo" id="tipo_cupo">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="tipo_cupo">Motivo de asignación de
                                        quirófano:</label>
                                    <select ref="tipo_reservacion" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.tipo_reservacion"
                                        class="form-control bg-gray-footer-parodi mr-1" name="tipo_reservacion"
                                        id="tipo_reservacion">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <select @input="updateFormField"
                                            v-model="$store.state.formReservacionQuirofano.nacionalidad"
                                            id="nacionalidad" class="flex-shrink-1 form-control bg-gray-footer-parodi"
                                            name="nacionalidad" style="width: fit-content;">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="cedula" ref="cedula" @change="searchCedula"
                                                @input="updateFormField"
                                                v-model="$store.state.formReservacionQuirofano.cedula" type="number"
                                                class="ml-1 flex-grow-1 form-control bg-gray-footer-parodi"
                                                name="cedula" aria-describedby="helpcedula">
                                            <div class="input-group-prepend">
                                                <div
                                                    :class="{ 'input-group-text p-0 ml-2 border-0 bg-transparent': true, 'd-none': !searchingCedula }">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" ref="email" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.email" type="email"
                                        class="form-control bg-gray-footer-parodi" name="email"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="nombres" ref="nombres" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.nombres" type="text"
                                        class="form-control bg-gray-footer-parodi" name="nombres"
                                        aria-describedby="helpId" placeholder="">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="apellidos" ref="apellidos" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.apellidos" type="text"
                                        class="form-control bg-gray-footer-parodi" name="apellidos"
                                        aria-describedby="helpId" placeholder="">
                                    <small id="helpId1" class="form-text text-muted notification"></small>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="genero" ref="genero" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.genero"
                                        class="form-control bg-gray-footer-parodi" name="genero"
                                        aria-describedby="helpId" placeholder="">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="date" ref="fnacimiento" @input="updateFormField"
                                            v-model="$store.state.formReservacionQuirofano.fnacimiento"
                                            class="form-control bg-gray-footer-parodi" name="fnacimiento"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="telefono_movil">Teléfono
                                        contacto</label>
                                    <input type="text" ref="telefono_movil" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.telefono_movil"
                                        class="form-control bg-gray-footer-parodi" name="telefono_movil"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="telefono_hogar">Teléfono
                                        secundario</label>
                                    <input type="text" ref="telefono_hogar" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.telefono_hogar"
                                        class="form-control bg-gray-footer-parodi" name="telefono_hogar"
                                        id="telefono_hogar" aria-describedby="helpId" placeholder="">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="n_presupuesto">Presupuesto
                                        nro:</label>
                                    <input ref="n_presupuesto" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.n_presupuesto" type="number"
                                        class="form-control bg-gray-footer-parodi" name="n_presupuesto"
                                        id="n_presupuesto">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="fecha_reservacion">Día de la círugía o
                                        estudio:</label>
                                    <input ref="fecha_reservacion" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.fecha_reservacion" type="date"
                                        class="form-control bg-gray-footer-parodi" name="fecha_reservacion"
                                        id="fecha_reservacion">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 " v-if="is_pendiente">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="h_inicio">Hora de inicio:</label>

                                    <input
                                        ref="h_inicio" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.h_inicio"
                                        type="time"
                            ...
                            <div class="col-12 col-sm-6" >
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="h_fin">Horas (estimadas) de
                                        duración:</label>

                                    <select ref="h_fin" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.h_fin"
                                        class="form-control bg-gray-footer-parodi" name="h_fin" id="h_fin">
                                        <option value="0.25">15 min</option>
                                        <option value="0.50">30 min</option>
                                        <option value="0.75">45 min</option>
                                        <option v-for="numero in numeros" :key="numero" :value="numero">{{ numero }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="dias_hospitalizacion">Días de
                                        Hospitalización:</label>
                                    <div class="d-flex align-items-center">
                                        <input ref="dias_hospitalizacion" @input="updateFormField"
                                            v-model="$store.state.formReservacionQuirofano.dias_hospitalizacion"
                                            type="number" class="form-control bg-gray-footer-parodi"
                                            name="dias_hospitalizacion" id="dias_hospitalizacion">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="dias_hospitalizacion">Días en
                                        UTI:</label>
                                    <input ref="dias_uti" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.dias_uti" type="number"
                                        class="form-control bg-gray-footer-parodi" name="dias_uti" id="dias_uti">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="diagnostico_preoperatorio">Diagnóstico
                                        pre-operatorio:</label>
                                    <input ref="diagnostico_preoperatorio" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.diagnostico_preoperatorio"
                                        type="text" class="form-control bg-gray-footer-parodi"
                                        name="diagnostico_preoperatorio" id="diagnostico_preoperatorio">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="n_quirofano">Quirófano:</label>
                                    <select ref="n_quirofano" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.n_quirofano"
                                        class="form-control bg-gray-footer-parodi mr-1" name="n_quirofano"
                                        id="n_quirofano">
                                        ...
                                        <option value="10">Sala de estudios especiales</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="label-text text-secondary" for="anestesia_sugerida">Anestesia
                                        sugerida:</label>
                                    <select ref="anestesia_sugerida" @input="updateFormField"
                                        v-model="$store.state.formReservacionQuirofano.anestesia_sugerida"
                                        class="form-control bg-gray-footer-parodi mr-1" name="anestesia_sugerida"
                            ...
                            <div class="container p-1 mb-3">
                                <div id="contenedor_intervencion">
                                    ...
                                    <div :ref="'item_' + index"
                                        v-for="(item, index) in $store.state.formReservacionQuirofano.intervencion"
                                        :key="index" class="container p-0 mb-2 align-items-center d-flex">

                                        <div class="row bg-light shadow-sm mt-2 rounded-custom-1">
                                            <div class="col-12">
                                                <label class="label-text text-secondary" for="intervencion"><b
                                                        v-if="$store.state.formReservacionQuirofano.intervencion.length > 1"
                                                        class="text-primary h3">{{ index + 1 }}</b> Intervención,
                                                    procedimiento o estudio a realizar:</label>
                                            </div>

                                            <div class="col-4 pb-1">
                                                <label class="label-text text-secondary" :for="'codigo'+index">Proced</label>
                                                <input
                                                    placeholder="Buscar por Código"
                                                    type="text"
                                                    class="form-control"
                                                    v-model="item.description.codigo"
                                                    @keyup.enter="getProced('codigo',index)"
                                                    @change="getProced('codigo',index)"
                                                >
                                            </div>
                                            <div class="col-4 pb-1">
                                                <label class="label-text text-secondary" :for="'description'+index">Descripción</label>
                                                <input
                                                    placeholder="Buscar por Descripción"
                                                    v-model="item.description.description"
                                                    type="text"
                                                    class="form-control"
                                                    @keyup.enter="getProced('description',index)"
                                                    @change="getProced('description',index)"

                                                >
                                            </div>
                                            <div class="col-4 pb-1">
                                                <label class="label-text text-secondary" :for="'description'+index">Kitsum asociado</label>
                                                <input
                                                    placeholder="Buscar por Kitsum"
                                                    type="text"
                                                    class="form-control"
                                                    v-model="item.description.kitsum_asociado"
                                                    @keyup.enter="getProced('kitsum_asociado',index)"
                                                    @change="getProced('kitsum_asociado',index)"
                                                >
                                            </div>
                                            <div class="col-12">
                                                <div v-if="item.description.resultset.length > 0"
                                                    class="table-responsive mt-1 table-hover" style="max-height:200px;">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr @click="addIntervencionItem(index, item2)"
                                                                class="text-secondary proced-found"
                                                                v-for="(item2, index2) in item.description.resultset"
                                                                :key="index2">
                                                                <td class="p-1" scope="row">{{ item2.codigo }}</td>
                                                                <td class="p-1">{{ item2.description }}</td>
                                                                <td class="p-1">{{ item2.kitsum_asociado }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <div
                                                class="col-12 col-sm-4 col-md-3 col-lg-4 d-flex flex-column p-0 pb-1 px-1">
                                                <label class="label-text text-secondary d-flex" for="">
                                                    Cirujano Prin<span class="d-sm-block d-none d-lg-none">.</span><span
                                                        class="d-sm-none d-lg-block">cipal</span>
                                                </label>
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="cirujano_principal"
                                                        :ref="'cirujano_principal_' + index"
                                                        :class="['form-control bg-gray-footer-parodi']">
                                                        <option value="">Seleccione</option>

                                                        <optgroup class="text-primary"
                                                            v-for="(grupoEspecialidad, indexEsp) in $store.state.especialidadesUnicas"
                                                            :key="indexEsp" :label="grupoEspecialidad">
                                                            <option class="text-secondary"
                                                                v-for="(item3, index3) in getGrupoEquipoSalud(grupoEspecialidad)"
                                                                :key="index3" :value="item3['id']">
                                                                {{ item3['description'] }}</option>
                                                        </optgroup>
                                                    </select>
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">

                                                        <div v-for="(item2, index2) in (item.hasOwnProperty('cirujano_principal') ? item['cirujano_principal'] : [])"
                                                            :key="index2" class="d-flex align-items-center mt-1">
                                                            <span class="text-secondary mx-1">{{ index2 + 1 }}</span>
                                                            <div :class="['flex-fill']">
                                                                {{ item2.description }}
                                                            </div>
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'cirujano_principal', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>


                                                        <div v-if="item['cirujano_principal'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                                            Seleccione Cirujano Prin<span
                                                                class="d-sm-block d-none">.</span><span
                                                                class="d-sm-none">cipal</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div
                                                class="col-12 col-sm-4 col-md-3 col-lg-4 d-flex flex-column p-0 pb-1 pr-1">
                                                <label class="label-text text-secondary d-flex" for="">
                                                    Ayudante 1
                                                </label>
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="ayudante_1"
                                                    ...
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">
                                                        <div v-for="(item2, index2) in item['ayudante_1']" :key="index2"
                                                            ...
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'ayudante_1', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>
                                                        <div v-if="item['ayudante_1'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="ayudante_2"
                                                    ...
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">
                                                        <div v-for="(item2, index2) in item['ayudante_2']" :key="index2"
                                                            class="d-flex align-items-center mt-1">
                                                            <span class="text-secondary mx-1">{{ index2 + 1 }}</span>
                                                            <div :class="['flex-fill']">
                                                                {{ item2.description }}
                                                            ...
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'ayudante_2', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>
                                                        <div v-if="item['ayudante_2'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="ayudante_3"
                                                    ...
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">
                                                        <div v-for="(item2, index2) in item['ayudante_3']" :key="index2"
                                                            class="d-flex align-items-center mt-1">
                                                            <span class="text-secondary mx-1">{{ index2 + 1 }}</span>
                                                            <div :class="['flex-fill']">
                                                                {{ item2.description }}
                                                            ...
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'ayudante_3', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>
                                                        <div v-if="item['ayudante_3'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="anestesiologo"
                                                        ...
                                                        <optgroup class="text-primary"
                                                            v-for="(grupoEspecialidad, indexEsp) in $store.state.especialidadesUnicas.filter(x => x === 'Anestesiología')"
                                                            :key="indexEsp" :label="grupoEspecialidad">
                                                            <option class="text-secondary"
                                                                v-for="(item3, index3) in getGrupoEquipoSalud(grupoEspecialidad)"
                                                                :key="index3" :value="item3['id']">
                                                    ...
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">
                                                        <div v-for="(item2, index2) in item['anestesiologo']"
                                                            :key="index2" class="d-flex align-items-center mt-1">
                                                            <span class="text-secondary mx-1">{{ index2 + 1 }}</span>
                                                            <div :class="['flex-fill']">
                                                                {{ item2.description }}
                                                            ...
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'anestesiologo', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>
                                                        <div v-if="item['anestesiologo'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                            ...
                                            <div
                                                ...
                                                <label class="mt-auto label-text text-secondary d-flex" for="">
                                                    Equipos Esp<span class="d-sm-block d-none d-lg-none">.</span><span
                                                        class="d-sm-none d-lg-block">eciales</span>
                                                </label>
                                                <div class="d-flex flex-column">
                                                    <select :data-index="index" data-ref="equipos_especiales"
                                                        :ref="'equipos_especiales_' + index"
                                                        :class="['form-control bg-gray-footer-parodi']">
                                                        <option value="">Seleccione</option>

                                                        <option class="text-secondary"
                                                            v-for="(item3, index3) in $store.state.equipos_especiales_options"
                                                            :key="index3" :value="item3">{{ item3 }}</option>
                                                    </select>
                                                    <div class="rounded-custom-1 mb-auto mt-1"
                                                        style="background-color: #efefef !important;">
                                                        <div v-for="(item2, index2) in item['equipos_especiales']"
                                                            :key="index2" class="d-flex align-items-center mt-1">
                                                            <span class="text-secondary mx-1">{{ index2 + 1 }}</span>
                                                            <div :class="['flex-fill']">
                                                                {{ item2.description }}
                                                            ...
                                                            <button
                                                                @click="destroyIntervencionItem(index, 'equipos_especiales', index2)"
                                                                class="ml-1 text-primary btn border-0"><i
                                                                    class="fa fa-times"></i></button>
                                                        </div>
                                                        <div v-if="item['equipos_especiales'].length === 0"
                                                            class="text-center text-secondary rounded p-2 d-flex justify-content-center align-items-center">
                                                            Seleccione Equipos Esp<span
                                                                class="d-sm-block d-none">.</span><span
                                                                class="d-sm-none">eciales</span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <button @click="addIntervencion()" class="btn btn-primary mt-2 btn-block"><i
                                        class="fa fa-plus"></i> Añadir otra intervención</button>
                            </div>
                            <div class="col-12 ">
                                <label class="label-text text-secondary" for="cat_user_ubicacion_id">Tipo de
                                    intervención:</label>
                                <div>
                                    ...
                                    <select
                                        ...
                                        ref="level4"
                                        v-model="$store.state.formReservacionQuirofano.area_intervencion"
                                        @change="handleDestino(4)"
                                        data-fieldName="area_intervencion"
                                    >
                                        <option  value="">Seleccione</option>
                                        <option class="text-primary" value="418">Hospitalización</option>
                                        <option class="text-primary" value="422">Ambulatoria Torre</option>

                                        <!-- <option v-for="(item,index) in $store.state['catUbicacion'].filter(item=> [424,425].includes(item['id']) )" :key="index" :value="item.id">{{item.coments}}</option> -->
                                    </select>
                                </div>
                            ...
                            <div class="d-none col-12 col-sm-6">

                                <div :class="{ 'd-none': !is_hospitalizacion }">
                                    <label class="label-text text-secondary"
                                        for="cat_user_ubicacion_id">Destino:</label>
                                    <select id="level0" class="form-control bg-gray-footer-parodi mb-1" ref="level0"
                                        @change="handleDestino(0)" data-fieldName="destino">
                                        <option value="">Seleccione</option>
                                        <option
                                            v-for="(item, index) in $store.state['catUbicacion'].filter(item => ![391, 390, 246, 223, 41, 2, 28, 182, 211, 391].includes(item['id']) && item['parent_cat_user_ubicacion_id'] === 1)"
                                ...
                                <div :class="{ 'd-none': !$store.state.inputLv1 }">
                                    <select id="level1" class="form-control bg-gray-footer-parodi mb-1" ref="level1"
                                        @change="handleDestino(1)" data-fieldName="destino">
                                        <option value="">Seleccione</option>
                                        <option v-for="(item, index) in $store.state['ubicaciones_level1']" :key="index"
                                            :value="item.id">{{ item.description }}</option>
                                    </select>
                                </div>
                                <div :class="{ 'd-none': !$store.state.inputLv2 }">
                                    <select id="level2" class="form-control bg-gray-footer-parodi mb-1" ref="level2"
                                        @change="handleDestino(2)" data-fieldName="destino">
                                        <option value="">Seleccione</option>
                                        <option v-for="(item, index) in $store.state['ubicaciones_level2']" :key="index"
                                            :value="item.id">{{ item.description }}</option>
                                    </select>
                                </div>
                                <div :class="{ 'd-none': !$store.state.inputLv3 }">
                                    <select id="level3" class="form-control bg-gray-footer-parodi mb-1" ref="level3"
                                        @change="handleDestino(3)" data-fieldName="destino">
                                        <option value="">Seleccione</option>
                                        <option v-for="(item, index) in $store.state['ubicaciones_level3']" :key="index"
                                            :value="item.id">{{ item.description }}</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-12 d-none">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input @change="handleFileChange" multiple type="file" ref="input_"
                                        class="form-control bg-gray-footer-parodi mr-1" name="input_"
                                        style="height: 43px;">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div v-for="(item, index) in uploadedFile" :key="index" class="col-12 col-sm-6">
                                        <div
                                            class="list-group-item-input-file my-1 overflow-auto d-flex justify-content-between align-items-center">
                                            <div class="flex-fill d-flex align-items-center">
                                                <i
                                                    :class="{ 'pc-pdf text-danger': item.typeFile == 'application/pdf', 'pc-imagenes text-info': item.typeFile == 'image/jpeg', ' m-1 display-3': true }"></i>
                                                <div class="flex-fill align-items-start d-flex flex-column">
                                                    <input :data-index="index" @input="updateFormFieldFile"
                                                        v-model="$store.state.formReservacionQuirofano.uploadedFile[index].coments"
                                                        type="text" class="form-control"
                                                        placeholder="Describe tu archivo aquí">
                                                    <b
                                                        class="text-secondary d-flex align-items-center text-left overflow-hidden">
                                            ...
                                            <button @click="destroyFile(index)"
                                                class="btn btn-danger mx-1 font-weight-bold">-</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="p-1 text-center">
                        ...
                        <button v-if="!edit_solicitudaaaaa" @click="submitForm" id="submit"
                            class="btn btn-success mt-1">Crear solicitud</button>
                        <button v-if="edit_solicitudaaaaa" @click="submitForm" id="submit"
                            class="btn btn-primary mt-1">Actualizar solicitud</button>
                        <button v-if="!edit_solicitudaaaaa" type="button" class="btn btn-info mt-1"
                            @click="resetForm">Limpiar Campos</button>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        is_pendiente() {
            let result = Number(this.$store.state.formReservacionQuirofano.n_quirofano) !== 1000
            let hoy = new Date();
    ...
    methods: {
        getProced(filter, index) {

            let stringSearch = this.$store.state.formReservacionQuirofano.intervencion[index]['description'][filter].toLowerCase().trim()
            let results = this.$store.state.procedimientos.filter(x => {
        ...
        addIntervencionItem(intervencion_index, item) {
            let { codigo, description, kitsum_asociado } = item
        ...
        handleDestino(param) {
            ...
            let value = Number(ubicaciones_level)
            let fieldName = this.$refs['level' + param].dataset['fieldname']
            ubicaciones_level = (ubicaciones_level !== "") && (ubicaciones_level !== "418") ? ubicaciones_level.split(",").map(item => Number(item)) : []
            if (Number(param) === 0) {
        ...
        validate() {
            ...
            if (this.$store.state.formReservacionQuirofano['intervencion'].length === 0) {
                ...
                let intervenciones_no_completadas = intervenciones.some(x =>  [null,""].includes(x['description']['codigo']) || [null,""].includes(x['description']['description']) )
                ...
                let cirujanos_faltantes = intervenciones.some(x =>  x['cirujano_principal'].length === 0 )
