...
<html xml:lang="es" xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div class="modal-header p-0">
                            <nav class="navbar navbar-light bg-primary m-0 p-0 justify-content-between">
                                ...
                                <a class="navbar-brand" href="#"  data-dismiss="modal" aria-label="Close">
                                    <img src="/image/system/logo-cmdlt_color.svg" style="height: 3em !important;width: 120px;" alt="Image logo system"
                                        loading="lazy">
                                </a>
                            </nav>
                    ...
                    <div class="modal-content">
                        <div class="modal-header p-0">
                            <nav class="navbar navbar-light bg-primary m-0 p-0 justify-content-between">
                                ...
                                <a class="navbar-brand" href="#"  data-dismiss="modal" aria-label="Close">
                                    <img src="/image/system/logo-cmdlt_mono.svg" style="height: 3em !important;width: 120px;" alt="Image logo system"
                                        loading="lazy">
                                </a>
                            </nav>
                                    ...
                                    <div class="row flex-nowrap overflow-auto w-100 secondary">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                            <ul class="nav nav-pills justify-content-md-center  justify-content-lg-end w-100" id="myTab" role="tablist">
                                                ...
                                                {{-- <li class="nav-item">
                                                    <a class="nav-link py-1" id="evolucion-tab" data-toggle="tab" href="#evolucion" role="tab" aria-controls="evolucion" aria-selected="false">Evolución</a>
                                                </li> --}}
                                            </ul>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-primary">
                        <div class="modal-header">
                            <img src="/image/system/logo-cmdlt_mono.svg" style="height: 3em;" class="img-fluid float-right"
                                alt="Imagen CMDLT">
    ...
    <script src="/class_js/CatUserCondicionMedica.js"></script>
    <script src="/class_js/CatUserEspecialidad.js"></script>
    <script src="/class_js/CatUserEstado.js"></script>
    <script src="/class_js/CatUserMunicipio.js"></script>
    <script src="/class_js/CatUserUbicacion.js"></script>
    <script src="/class_js/Component.js"></script>
    <script src="/class_js/SystemIncidencia.js"></script>
    <script src="/class_js/User.js"></script>
    <script src="/class_js/UserCentroSalud.js"></script>
    <script src="/class_js/CatUserAlergia.js"></script>
    <script src="/class_js/UserCuestAntecedente.js"></script>
    <script src="/class_js/UserCuestAntg.js"></script>
    <script src="/class_js/UserCuestChat.js"></script>
    <script src="/class_js/UserCuestComorbilidad.js"></script>
    <script src="/class_js/UserCuestDireccion.js"></script>
    <script src="/class_js/UserCuestEgreso.js"></script>
    <script src="/class_js/UserCuestEpisodio.js"></script>
    <script src="/class_js/UserCuestEstudioDiagnostico.js"></script>
    <script src="/class_js/UserCuestEvolucion.js"></script>
    <script src="/class_js/UserCuestFc.js"></script>
    <script src="/class_js/UserCuestFichaMedica.js"></script>
    <script src="/class_js/UserCuestFotografia.js"></script>
    <script src="/class_js/UserCuestFr.js"></script>
    <script src="/class_js/UserCuestGl.js"></script>
    <script src="/class_js/UserCuestHistoria.js"></script>
    <script src="/class_js/UserCuestImagen.js"></script>
    <script src="/class_js/UserCuestImpresionDiagnostica.js"></script>
    <script src="/class_js/UserCuestIncidencia.js"></script>
    <script src="/class_js/UserCuestInforme.js"></script>
    <script src="/class_js/UserCuestLaboratorio.js"></script>
    <script src="/class_js/UserCuestMedicoPaciente.js"></script>
    <script src="/class_js/UserCuestObservacion.js"></script>
    <script src="/class_js/UserCuestOtroArchivo.js"></script>
    <script src="/class_js/UserCuestOxigenoterapia.js"></script>
    <script src="/class_js/UserCuestOximetria.js"></script>
    <script src="/class_js/UserCuestPaciente.js"></script>
    <script src="/class_js/UserCuestPad.js"></script>
    <script src="/class_js/UserCuestPcr.js"></script>
    <script src="/class_js/UserCuestPdr.js"></script>
    <script src="/class_js/UserCuestPendiente.js"></script>
    <script src="/class_js/UserCuestPlan.js"></script>
    <script src="/class_js/UserCuestPruebaCovid.js"></script>
    <script src="/class_js/UserCuestRecipe.js"></script>
    <script src="/class_js/UserCuestSintoma.js"></script>
    <script src="/class_js/UserCuestTa.js"></script>
    <script src="/class_js/UserCuestTac.js"></script>
    <script src="/class_js/UserCuestTemperatura.js"></script>
    <script src="/class_js/UserCuestUbicacion.js"></script>
    <script src="/class_js/UserCuestValoracion.js"></script>
    <script src="/class_js/UserCuestVinculoInstitucion.js"></script>
    <script src="/class_js/UserEncuesta.js"></script>
    <script src="/class_js/UserEnfermedadActual.js"></script>
    <script src="/class_js/UserEquipoSalud.js"></script>
    <script src="/class_js/UserEspecialidad.js"></script>
    <script src="/class_js/UserExamenFisico.js"></script>
    <script src="/class_js/UserFamily.js"></script>
    <script src="/class_js/UserMedico.js"></script>
    <script src="/class_js/UserMedicoAgenda.js"></script>
    <script src="/class_js/UserMedicoPosicion.js"></script>
    <script src="/class_js/UserPostCovid.js"></script>
    <script src="/class_js/UserProblemaSalud.js"></script>
    <script src="/class_js/UserProfile.js"></script>
    <script src="/class_js/UserType.js"></script>
    <script src="/class_js/UserVIP.js"></script>
