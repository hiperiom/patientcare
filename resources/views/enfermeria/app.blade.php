        ...
        <nav class="row bg-light rounded border mx-1 mb-1">
            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-8 col-xl-8 d-none d-md-block order-2 order-lg-2 p-1">
                <div class="d-flex justify-content-end" id="btnNotificaciones">
                    ...
                    <button type="button" class="text-uppercase d-flex flex-nowrap align-items-center text-primary font-weight-bold btn btn-gray float-right mr-1">

                        <span class="mr-1">Emergencia</span>
                        <span class="badge badge-light text-secondary">0</span>
                    </button>
                    <button type="button" class="text-uppercase d-flex flex-nowrap align-items-center text-primary font-weight-bold btn btn-gray float-right mr-1">
                        <span class="mr-1">Hospitalizados</span>
                        <span class="badge badge-light text-secondary">0</span>
                    </button>
                    <button type="button" class="text-uppercase d-flex flex-nowrap align-items-center text-primary font-weight-bold btn btn-gray float-right mr-1">
                        <span class="mr-1">UTI</span>
                        <span class="badge badge-light text-secondary">0</span>
                    </button>
                    <button type="button" class="text-uppercase d-flex flex-nowrap align-items-center text-primary font-weight-bold btn btn-gray float-right mr-1">
                        <span class="mr-1">PAD</span>
                        <span class="badge badge-light text-secondary">0</span>
                    </button>
            ...
            <div class="col-7 bg-danger col-sm-8 col-md-4 col-lg-4 col-xl-4 p-1 order-2 d-flex">
