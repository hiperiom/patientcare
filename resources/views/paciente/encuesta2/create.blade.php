    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function(){
            ...
            let user_encuesta = [
                ...
                {
                    id:5,
                    description:`Evaluación Cmdlt (el Proceso)`,
                    coment:""
                },
                {
                    id:6,
                    description:`Evaluación Cmdlt (la institución)`,
                    coment:""
                },
            ...
            let user_encuesta_preg = [
                //Cita
                    {
                        id:1,
                        description:`¿Te fúe facil contactar al especialista deseado y pautar tu cita?`,
                        coment:"",
                        grupo_respuesta:5,
                ...
                //Ambiente fisico
                    {
                        id:2,
                        description:`En una escala del 1 al 5 siendo 1 el peor, y 5 el mejor, ¿Cómo evaluas el ambiente de espera?`,
                        coment:"",
                        grupo_respuesta:10,
                ...
                //Atención
                    {
                        id:3,
                        description:`¿Te atendieron con puntualidad a la hora prevista?`,
                        coment:"",
                        grupo_respuesta:5,
                ...
                //Especialistas
                    {
                        id:4,
                        description:`¿El especialista escuchó atentamente tu problema de salud?`,
                        coment:"",
                        grupo_respuesta:5,
                    ...
                    {
                        id:5,
                        description:`¿El especialista te explicó en un lenguaje sencillo y entendible tu condición de salud?`,
                        coment:"",
                        grupo_respuesta:5,
                        cat_encuesta_preg_id:4,
                        parent:null,
                    ...
                    {
                        id:6,
                        description:`¿Entendiste el plan propuesto por el especialista para mejorar tu condición de salud?`,
                        coment:"",
                        grupo_respuesta:5,
                        cat_encuesta_preg_id:4,
                        parent:null,
                    ...
                    {
                        id:7,
                        description:`¿Sientes confianza y estás de acuerdo con el plan propuesto por el especialista?`,
                        coment:"",
                        grupo_respuesta:5,
                        cat_encuesta_preg_id:4,
                        parent:null,
                ...
                //Evaluacion cmdlt proceso
                    {
                        id:8,
                        description:`En una escala del 1 al 5 siendo 1 el peor, y 5 el mejor, ¿Cómo calificarias el proceso de la consulta?`,
                        coment:"",
                        grupo_respuesta:10,
                ...
                //Evaluacion cmdlt institucion
                    {
                        id:9,
                        description:`¿Calificarías al CMDLT para consultas externas a familiares y amigos?`,
                        coment:"",
                        grupo_respuesta:5,
            ...
            let tituloEncuesta = `Encuesta de Atención en Consulta Externa`
                    ...
                    cancelButtonText: 'No',
                        ...
                        if (result.isConfirmed) {
                            //if(User.validate()){
                                ...
                                try {
                                    let model = await UserEncuesta.store(2)
