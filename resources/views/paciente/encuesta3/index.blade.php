    ...
    <script>
        ...
        class Encuesta1 {
            constructor(props){
                ...
                const   f = new Date();
                    ...
                    this.state = state !== undefined ? state : {
                        ...
                        test_section:[
                            {
                                id:"ComunicacionyAdmision",
                                user_encuesta_id:1,
                                title:"Comunicación y Admisión",
                                value:0,
                                coment:[],
                                valueIndice:`%`,
                            ...
                            {
                                id:"MedicoObservacion",
                                user_encuesta_id:3,
                                title:"Médico Observación",
                                value:0,
                                coment:[],
                                valueIndice:`%`,
                            ...
                            {
                                id:"EnfermeriaObservacion",
                                user_encuesta_id:5,
                                title:"Enfermería Observación",
                                value:0,
                                coment:[],
                                valueIndice:`%`,
                    ...
                    this.date_start = f.getFullYear() + "-" + ("0" + (f.getMonth()+1)).slice(-2) + "-" + "01";
                ...
                let data = null;
                    ...
                    d.querySelector("body").addEventListener("click", async (e) => {
                        ...
                        if (!e.target.matches(".btn-sync-encuesta")) return false;
            ...
            getDetalle(pregunta_id){
                ...
                //console.log(encuesta['test_section'].filter(a=>a.user_encuesta_id === pregunta_id))
                let {
                    title,
                    value,
                    icon,
                    ...
                    textColor,
                    coment
                } = first(encuesta['test_section'].filter(a=>a.user_encuesta_id === pregunta_id))
            ...
            render(){
                ...
                let testheader = $main.querySelector(".test-header .info-box-content .info-box-number");
                    testheader.textContent = data.test_header.test_total;
            ...
            render_header(){
                ...
                let $item1 = col()
                    ...
                    $item1.querySelector(".info-box-content").innerHTML =`
                            <span class="info-box-text text-primary font-weight-bold">Total Encuestas <button class="btn-sync-encuesta btn-sm btn btn-default float-right text-primary font-weight-bold"><i class="fas btn-sync-encuesta fa-sync-alt"></i></button></span>
            ...
            async getAll(){
                ...
                let formdata = new FormData();
                    ...
                    formdata.append("user_encuesta_id", 3)
