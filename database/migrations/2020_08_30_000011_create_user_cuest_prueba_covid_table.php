...
class CreateUserCuestPruebaCovidTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_cuest_prueba_covid', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->bigIncrements('id');
            $table->unsignedBigInteger('cat_user_cuestionario_id');
            $table->text('value')->nullable();
            $table->text('value2')->nullable();
            $table->text('fecha_prueba')->nullable();
            $table->boolean('igm')->default("0");
            $table->boolean('igg')->default("0");
    ...
    {
        Schema::dropIfExists('user_cuest_prueba_covid');
    }
}
