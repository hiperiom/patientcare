...
class CreateUserCuestLaboratorioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_cuest_laboratorio', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->unsignedBigInteger('cat_user_laboratorio_id')->nullable();
            ...
            $table->foreign('cat_user_laboratorio_id')->references('id')->on('cat_user_laboratorio')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('user_cuest_laboratorio');
    }
}
