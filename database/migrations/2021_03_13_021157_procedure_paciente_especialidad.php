...
class ProcedurePacienteEspecialidad extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    /*
        DB::statement("
            #USE qdvkztswjy;
            DROP PROCEDURE IF EXISTS paciente_covid_especialidad;
            DELIMITER //
                CREATE PROCEDURE paciente_covid_especialidad
                (
                    IN _especialidad INT (30)
                )
                BEGIN
                    ...
                    SET @query =CONCAT("
                        ...
                        AND user_especialidad.cat_user_especialidad_id =",_especialidad,"
