...
class CreateUserCuestFrTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_cuest_fr', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->unsignedBigInteger('user_id_medico')->nullable();$table->unsignedBigInteger('user_cita_id')->nullable();
            $table->timestamps();
            $table->softDeletesTz();
    ...
    {
        Schema::dropIfExists('user_cuest_fr');
    }
}
