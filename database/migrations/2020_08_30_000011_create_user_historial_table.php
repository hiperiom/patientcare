...
class CreateUserHistorialTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_historial', function (Blueprint $table) {
            ...
            //$table->unsignedBigInteger('cat_user_historial_id');
            ...
            //$table->foreign('cat_user_historial_id')->references('id')->on('cat_user_historial')->onDelete('cascade');
