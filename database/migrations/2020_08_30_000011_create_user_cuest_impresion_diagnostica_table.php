...
class CreateUserCuestImpresionDiagnosticaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_cuest_imp_diagn', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('user_cuest_imp_diagn');
    }
}
