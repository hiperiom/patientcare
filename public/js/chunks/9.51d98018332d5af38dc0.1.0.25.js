...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    getPersonalComputed: function getPersonalComputed() {
      return this.solicitud.personal_asistencial;
    },
...
var render = function render() {
  ...
  }, [_vm._v("\n    " + _vm._s(JSON.parse(this.solicitud.personal_asistencial)) + "\n    "), _c("ul", {
    staticClass: "list-group list-group-flush p-0"
  }, _vm._l(JSON.parse(this.solicitud.personal_asistencial), function (item, index) {
    return _c("li", {
      key: index,
