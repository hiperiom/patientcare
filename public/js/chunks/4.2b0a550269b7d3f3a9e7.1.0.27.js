  ...
  methods: {
    ...
    qxRealizada: function qxRealizada(e) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6() {
        var _e$currentTarget$data3, index, index2, reservacion_id, _this3$$store$state$l, n_quirofano, fase_ubicacion, h_inicio, h_real_inicio, intervencion, destino, tipo_reservacion, personal_asistencial, tempIntervencion, canestesia, ccirugia, instrumentista, solicitud, ultimoRegistro, fecha_cirugia;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _this3$$store$state$l = _this3.$store.state.listadoSolicitudesQx[index]['dias'][index2], n_quirofano = _this3$$store$state$l.n_quirofano, fase_ubicacion = _this3$$store$state$l.fase_ubicacion, h_inicio = _this3$$store$state$l.h_inicio, h_real_inicio = _this3$$store$state$l.h_real_inicio, intervencion = _this3$$store$state$l.intervencion, destino = _this3$$store$state$l.destino, tipo_reservacion = _this3$$store$state$l.tipo_reservacion, personal_asistencial = _this3$$store$state$l.personal_asistencial; //console.log(this.$store.state.listadoSolicitudesQx[index]['dias'][index2]);
              ...
              case 33:
                if (!([null, 'null', undefined, 'undefined'].includes(destino) && tipo_reservacion !== 'Emergencia')) {
                  _context6.next = 36;
                  break;
                }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                ...
                console.log(_this3.index2, _this3.index, _this3.fieldName, input_value);
