...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getActiveColor: function getActiveColor(item) {
      console.log("1--->", this.personal_asistencial);
      console.log("2--->", item); //let result = this.personal_asistencial.some(x => x.user_id === Number(item.user_id) && x.tipo_personal === this.name)
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = _this.getPersonal(_this.name).id;
                formData = new FormData();
                formData.append("id", id);
                formData.append("field", 'active');
                formData.append("value", 0);
