          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!_this.personal_asistencial.map(function (x) {
                  return x.user_id;
                }).includes(Number(_this.user_id_medico))) {
                  _context2.next = 5;
                  break;
                }
              ...
              case 14:
                ...
                _this.$store.commit('updateSolicitudQx2', [_this.index_dia, _this.index_solicitud, 'personal_asistencial', [].concat(_toConsumableArray(newData), _toConsumableArray(result))]);

                console.log("solicitud->", _this.$store.state.listadoSolicitudesQx[_this.index_dia].dias[_this.index_solicitud].personal_asistencial);
