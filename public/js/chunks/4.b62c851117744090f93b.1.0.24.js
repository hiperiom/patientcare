          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 14:
                ...
                _this.$store.commit('updateSolicitudQx2', [_this.index_dia, _this.index_solicitud, 'personal_asistencial', newData]); //console.log("solicitud->", this.$store.state.listadoSolicitudesQx[this.index_dia].dias[this.index_solicitud].personal_asistencial);
