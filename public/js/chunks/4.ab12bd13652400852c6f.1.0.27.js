  ...
  methods: {
    ...
    qxRealizada: function qxRealizada(e) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6() {
        var _e$currentTarget$data3, index, index2, reservacion_id, _this3$$store$state$l, n_quirofano, fase_ubicacion, h_inicio, h_real_inicio, intervencion, destino, personal_asistencial, tempIntervencion, canestesia, ccirugia, instrumentista, solicitud, ultimoRegistro, fecha_cirugia;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _this3$$store$state$l = _this3.$store.state.listadoSolicitudesQx[index]['dias'][index2], n_quirofano = _this3$$store$state$l.n_quirofano, fase_ubicacion = _this3$$store$state$l.fase_ubicacion, h_inicio = _this3$$store$state$l.h_inicio, h_real_inicio = _this3$$store$state$l.h_real_inicio, intervencion = _this3$$store$state$l.intervencion, destino = _this3$$store$state$l.destino, personal_asistencial = _this3$$store$state$l.personal_asistencial; //console.log(this.$store.state.listadoSolicitudesQx[index]['dias'][index2]);
              ...
              case 29:
                ...
                return _context6.abrupt("return", false);
              case 33:
                if (![null, 'null', undefined, 'undefined'].includes(destino)) {
                  _context6.next = 36;
                  break;
                }
                Swal.fire({
                                        ...
                                        [
                                          _c("div", { staticClass: "d-flex" }, [
                                            _c(
                                              ...
                                              {
                                                staticClass:
                                                  "flex-grow-1 d-flex justify-content-center btn-group dropup",
                                              },
                                              [
                                                !item2.h_fin
                                                  ? _c(
                                                        ...
                                                        _vm._s(
                                                          _vm.fechaFormat(
                                                            item2.fecha_reservacion
                                                              ? item2.fecha_reservacion
                                                              : item2.fecha_reservacion_original
                                                          )
                                                        ) +
                                                        "\n                                            "
                                                    ),
