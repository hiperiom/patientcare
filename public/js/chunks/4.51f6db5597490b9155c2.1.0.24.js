        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 14:
                result = _context2.sent;
                newData = _this.$store.state.listadoSolicitudesQx[_this.index_dia].dias[_this.index_solicitud].personal_asistencial.filter(function (x) {
                  return x.tipo_personal !== _this.name;
                });
                /* .map(x => {
                ...
                _this.$store.commit('updateSolicitudQx2', [_this.index_dia, _this.index_solicitud, 'personal_asistencial', newData]);
