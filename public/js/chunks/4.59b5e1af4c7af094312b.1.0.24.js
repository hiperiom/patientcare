...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['n_quirofano', 'user_id_paciente', 'solicitud_quirofano_id', 'personal_asistencial', 'siglas', 'color', 'title', 'name'],
  ...
  methods: {
    ...
    getPersonal: function getPersonal(tipo_personal) {
      ...
      /* let personalAsistencial = this.$store.state.personalAsistencial
          .map(x => x.personal_asistencial)
          .flat()
          .filter(x => Number(x['solicitud_quirofano_id']) === Number(this.solicitud_quirofano_id)) */

      /* if(this.n_quirofano !==1000){ */
      //let quirofano = this.$store.state.personalAsistencial.find(x=>Number(x['id']) === Number(this.n_quirofano) )
      //console.log("personalAsistencial-------->",this.$store.state.personalAsistencial);
      //console.log("n_quirofano-------->",this.n_quirofano);
      //console.log("-------->",quirofano);

      /* if ( !is_undefined(quirofano) && Object.hasOwnProperty.call(quirofano, 'personal_asistencial') ) {
          personalAsistencial =   quirofano['personal_asistencial'].filter(x=>
                                      x['tipo_personal'] === this.name &&
                                      Number(x['solicitud_quirofano_id']) === Number(this.solicitud_quirofano_id)  &&
                                      Number(x['active']) === 1
                                  )
      } */
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                result = _context.sent;
                indexQuirofano = _this.$store.state.personalAsistencial.findIndex(function (x) {
                  return x['id'] === _this.n_quirofano;
                });

                _this.$store.commit('destroyPersonalAsistencialEnfermeria', {
                  index: indexQuirofano,
                  id: id,
                  tipo_personal: _this.name,
                  field: 'active',
                  value: 0
                }); //this.$store.state.personalAsistencial[ index ][field]
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!_this2.getPersonal().map(function (x) {
                  return x.user_id;
                }).includes(Number(_this2.user_id_medico))) {
                  _context2.next = 4;
                  break;
                }

                alert("Ya has seleccionado a esta persona");
                _this2.user_id_medico = "";
                return _context2.abrupt("return", false);

              case 4:
                if (!(_this2.n_quirofano === 1000)) {
                  _context2.next = 7;
                  break;
                }

                alert("Debes seleccionar un Quirófano antes de añadir personal asistencial.");
                return _context2.abrupt("return", false);

              case 7:
                _context2.prev = 7;
                formData = new FormData();
                formData.append("cat_quirofano_id", _this2.n_quirofano);
                formData.append("user_id", _this2.user_id_medico);
                formData.append("tipo_personal", _this2.name);
                formData.append("solicitud_quirofano_id", _this2.solicitud_quirofano_id);
                formData.append("_token", document.querySelector('meta[name="csrf-token"]').getAttribute('content'));
                _context2.next = 16;
                return Object(_helpers_customHelpers__WEBPACK_IMPORTED_MODULE_1__["post"])(location.origin + "/areaQuirofano/personal_asistencial/create", formData);
              ...
              case 16:
                ...
                peronalAsistencial = _this2.$store.state.personalAsistencial.findIndex(function (x) {
                  return x['id'] === _this2.n_quirofano;
                });
                ...
                _this2.$store.commit('updatePersonalAsistencialQx', {
                  index: indexQuirofano,
                  value: newData
                });

                _this2.$store.commit('updatePersonalAsistencialEnfermeria', {
                  index: indexQuirofano,
                  value: result
                });
  ...
  mounted: function mounted() {
    ...
    this.$refs["myList" + this.user_id_paciente].addEventListener("click", function (e) {
      _this3.user_id_medico = e.target.dataset.user_id;

      _this3.handleAddPersonal();
    });
  }
});
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "list-group list-group-flush p-0"
  }, [_vm._l(_vm.getPersonal("c_anestesia"), function (item, index) {
    return _c("li", {
      key: index,
      staticClass: "list-group-item text-nowrap d-flex justify-content-between align-items-center p-0"
    }, [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.siglas))])])]) : _vm._e(), _vm._v(" "), _vm._l(_vm.getPersonal("c_cirugia"), function (item, index) {
    return _c("li", {
      key: index,
      staticClass: "list-group-item text-nowrap d-flex justify-content-between align-items-center p-0"
    }, [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.siglas))])])]) : _vm._e(), _vm._v(" "), _vm._l(_vm.getPersonal("instrumentista"), function (item, index) {
    return _c("li", {
      key: index,
      staticClass: "list-group-item text-nowrap d-flex justify-content-between align-items-center p-0"
    }, [_c("div", {
