...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getPersonal: function getPersonal(tipo_personal) {
      ...
      /* } */
      console.log("-------->", this.personal_asistencial);
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "flex-grow-1 pr-1"
  }, [_vm._v("\n        " + _vm._s(_vm.getPersonal(_vm.name)) + "\n        "), _c("ul", {
    staticClass: "list-group list-group-flush p-0"
    ...
    on: {
      click: function click($event) {
        return _vm.handleDestroyPersonal(_vm.item.id, _vm.index);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-times"
  })])]) : _vm._e(), _vm._v(" "), _vm.getPersonal().length === 0 ? _c("li", {
    staticClass: "list-group-item text-nowrap d-flex align-items-center p-0",
    staticStyle: {
      width: "200px"
    }
  ...
  }, [_vm._v(_vm._s(_vm.siglas))])])]) : _vm._e()])])]);
};
