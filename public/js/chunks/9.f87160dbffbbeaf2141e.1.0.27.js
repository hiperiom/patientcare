...
var render = function render() {
  ...
  return _c("main", {
    ...
    return _c("div", {
      ...
      return _c("tr", {
      ...
      }, [[1, 2, 3, 4, 5, 6, 7, 8, 9].includes(solicitud["n_quirofano"]) ? _c("h3", {
        staticClass: "mb-0",
        style: {
          color: "white"
        }
      }, [_vm._v("\n                                            QX" + _vm._s(solicitud["n_quirofano"]) + "\n                                        ")]) : [10].includes(solicitud["n_quirofano"]) ? _c("h3", {
        staticClass: "mb-0",
        style: {
          color: "white"
        }
        ...
        "class": ["text-center text-nowrap align-items-center", {
          "d-none": solicitud.fase_ubicacion === "En espera de clave" || _vm.getHistorialHorasQx(solicitud).length > 1 || !solicitud["h_inicio"] && !solicitud["h_real_inicio"]
        }, {
      ...
      }), _vm._v("\n                                            " + _vm._s(solicitud["h_inicio"] ? _vm.get_hora_inicio(solicitud["h_inicio"]) : "11111--:--") + "\n                                        ")]), _vm._v(" "), _c("div", {
        "class": [{
      ...
      }, [solicitud["h_real_inicio"] ? _c("i", {
        staticClass: "pc-clock-update mr-1"
      }) : _vm._e(), _vm._v("\n                                            " + _vm._s(solicitud["h_real_inicio"] ? _vm.horaAMPM(JSON.parse(solicitud["h_real_inicio"])[JSON.parse(solicitud["h_real_inicio"]).length - 1]["h_inicio"]) : "--:--") + "\n                                        ")])]), _vm._v(" "), _c("td", {
        staticClass: "text-center py-0 text-white"
      }, [_c("div", {
        "class": ["flex-column", {
        ...
        staticClass: "d-flex flex-column mb-1 justify-content-start p-1",
        staticStyle: {
      ...
      }), _vm._v(" "), _c("div", [_vm._v("Ambu.")])]) : _vm._e()]), _vm._v(" "), _c("td", {
    ...
    style: "vertical-align:middle;color:".concat(_vm.row["backgroundColor"], ";")
  }, [_c("ul", {
