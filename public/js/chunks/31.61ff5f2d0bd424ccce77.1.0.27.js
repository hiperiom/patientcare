          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formdata.append("user_id", JSON.parse(localStorage.getItem("user_profile"))['user_id']); //formdata.append("_token", document.querySelector('meta[name="csrf-token"]').getAttribute('content'))

                formdata.append("_token", $("#_token").val());
                _context.next = 5;
                return post(location.origin + "/auth/getUserRoles", formdata);
