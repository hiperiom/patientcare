            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 19:
                ...
                canestesia = personal_asistencial.filter(function (x) {
                  return (x === null || x === void 0 ? void 0 : x.tipo_personal) === 'c_anestesia';
                });
              ...
              case 24:
                ccirugia = personal_asistencial.filter(function (x) {
                  return (x === null || x === void 0 ? void 0 : x.tipo_personal) === 'c_cirugia';
                });
              ...
              case 28:
                instrumentista = personal_asistencial.filter(function (x) {
                  return (x === null || x === void 0 ? void 0 : x.tipo_personal) === 'instrumentista';
                });
            ...
            switch (_context8.prev = _context8.next) {
              ...
              case 12:
                ...
                fechas_unicas = Array.from(new Set(model.filter(function (item) {
                  ...
                  var h_inicio = item['fecha_reservacion'].split(" ");
                  return h_inicio[0];
                }))) //eliminamos los valores null
                .filter(function (item) {
                  return item !== null;
                ...
                console.log(model); //asignamos las solicitudes organizandolas por las fechas unicas 

                fechas_unicas.forEach(function (item) {
                  solicitudesPorDia.push({
                    fecha: item.original,
                    dias: model.filter(function (item2) {
                      console.log(item2['fecha_reservacion']);
                      /* if (item2['h_inicio'] === null) {
                          let h_inicio = item2['fecha_reservacion_original']
