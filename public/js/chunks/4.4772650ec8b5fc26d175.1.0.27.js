  ...
  data: function data() {
    return {
      ...
      selectOptions1: this.$store.state['catUbicacion'].filter(function (item) {
        return ![391, 390, 246, 223, 41, 2, 28, 211, 391].includes(item['id']) && item['parent_cat_user_ubicacion_id'] === 1;
      }),
      selectOptions2: "",
      selectOptions3: "",
      defaultValue: 0,
  ...
  return _c("div", {
    ...
    return _c("div", {
      ...
      return _c("tr", {
        ...
        staticClass: "flex-grow-1 btn-group btn-link dropup"
      }, [_c("button", {
      ...
      }, [_vm._v("QX" + _vm._s(item2.n_quirofano))]) : item2.n_quirofano === 10 ? _c("h1", {
        staticClass: "font-weight-bold",
        style: {
          color: _vm.getBgColor(item2.n_quirofano)
        }
