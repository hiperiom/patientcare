class UserCuestRiesgoQuirurgico {
    constructor({value=1, user_id_paciente=null,description=null,episodio_id=null}){
        ...
        this.model_name = "cirugia"
        this.description = "Estable"
        this.icon = "pc-cirugia"
        this.color = "success"
    ...
    buttom(){
            ...
            return `<span data-tippy-content="<b><i class='${this.icon}'></i> Infección de herida:</b> ${this.description} <br> <small>${this.message}</small>" style='font-size: 20px !important;' class='tooltip-cmdlt-${this.color} ${this.prioridad} text-${this.color} ${this.animation} heartbeat p-0 m-0 font-weight-bold'><i class="${this.icon}"></i></span>`
    }
    async store(){
