class UserCuestOrdenMedica {
    ...
    static create(selector, user_id) {
        ...
        $("#user_cuest_model_store").on("click", function() {
            if (UserCuestOrdenMedica.validate()) {
                UserCuestOrdenMedica.store(user_id)
                    .then(response => {
    ...
    static store(user_id) {
        ...
        return post(location.origin+"/user_cuest_orden_medica/store", formdata)
            ...
            function(data, textStatus, jqXHR) {
                ...
                if (data.length > 0) {
                            ...
                            chat += `
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body" style="font-size: 0.5em;">
                                                ${dato}
                    ...
                    chat += `
                        <div>
                            <div class="timeline-item">
                                <div class="timeline-body text-center text-primary font-weight-bold" style="font-size: 0.5em;">
                                    No posee historial
                                </div>
                            </div>
                        </div>
    ...
    static destroy(id, user_id) {
        ...
        if (r == true) {
            get( location.origin+"/user_cuest_orden_medica/destroy/" + id)
                .then(response => {
                    UserCuestHistoria.index('.modal-body', user_id)
                })
        }
